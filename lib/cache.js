 ...
 */
FileStore.prototype.serve = function(url, req, res, callback) {
 ...
 */
FileStore.prototype.save = function(url, html, callback) {
...
FileStore.prototype.parseUrl = function(url, callback) {
